            ...
            <div class="navbar-default sidebar" role="navigation">
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
                        ...
                        <li>
                            <a href="?module=modulprak"><i class="fa fa-file fa-fw"></i>Kelola Modul Praktikum</a>
                        </li>

                        <li>
                            <a href="?module=modul"><i class="fa fa-file fa-fw"></i>Kelola Tes Awal dan Tes Akhir</a>
                        </li>
                        ...
                        <li>
                         ...
                         <li>
                            <a href="?module=hasilujian"><i class="fa fa-file fa-fw"></i>Hasil Tes Awal</a>
                        </li>

                        <li>
                           <a href="?module=hasilujianakhir"><i class="fa fa-file fa-fw"></i>Hasil Tes Akhir</a>
                       </li>
