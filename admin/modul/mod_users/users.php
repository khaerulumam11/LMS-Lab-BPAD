...
switch($_GET[act]){
  ...
  default:
    ...
    <table class='table table-striped table-bordered table-hover'>
          <tr><th>no</th><th>Username</th><th>Nama</th><th>NIM</th><th>Kelas</th><th>Jenis Kelamin</th><th>Aktif</th><th>Lihat</th><th>aksi</th><th>Status</th></tr>";
    $no=1;
  ...
  case "lihat":
       $tampil = mysqli_query($config,"SELECT * FROM tbl_user WHERE id_user='$_GET[id]'");
  ...
  <table width='60%'>
    ...
    <tr><td>NIM</td><td>$t[nim]</td></tr>
    <tr><td>Kelas</td><td>$t[kelas]</td></tr>
