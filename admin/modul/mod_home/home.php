...
$sql_nilai_l  = mysqli_query($config,"SELECT count(*) as jum FROM tbl_nilai WHERE keterangan='Lulus'");
$r_nilai_l    = mysqli_fetch_array($sql_nilai_l);
$lulus=$r_nilai_l['jum'];

$sql_nilai_tl  = mysqli_query($config,"SELECT count(*) as jum FROM tbl_nilai WHERE keterangan='Tidak Lulus'");
$r_nilai_tl    = mysqli_fetch_array($sql_nilai_tl);
$tidak_lulus=$r_nilai_tl['jum'];

$sql_user  = mysqli_query($config,"SELECT count(*) as jum FROM tbl_user WHERE statusaktif='Y'");
$r_user    = mysqli_fetch_array($sql_user);
$total_user=$r_user['jum'];

$sql_soal  = mysqli_query($config,"SELECT count(*) as jum FROM tbl_soal WHERE aktif='Y'");
