...
switch($_GET[act]){
  ...
  default:
      $tampil = mysqli_query($config,"SELECT * FROM tbl_nilai,tbl_user,tbl_modul WHERE tbl_nilai.id_user=tbl_user.id_user AND tbl_nilai.id_modul = tbl_modul.id_modul");
      echo "<h2>Hasil Tes Awal</h2>
...
<a href='../admin/export_excel1.php' class='btn btn-primary'>Download Nilai Tes Akhir</a>
