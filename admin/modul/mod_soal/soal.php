...
switch($_GET[act]){
  ...
  //Tampil Data Soal
     echo" <table class='table table-striped table-bordered table-hover'>
          <tr><th>No</th><th>Pertanyaan</th><th>Status</th><th>aksi</th><th>View</th><th>Nama Modul</th><th>Pilihan Tes</th><th></th></tr>";
    $tampil=mysqli_query($config,"SELECT * FROM tbl_soal,tbl_modul,tbl_modulprak where tbl_soal.id_modul = tbl_modul.id_modul AND tbl_modul.id_modulprak = tbl_modulprak.id_modul  ORDER BY tbl_soal.id_soal DESC");
    $no=1;
  ...
  case "tambahsoal":
    echo "<h2>Tambah Soal</h2>
          ...
          $tampil1=mysqli_query($config,"SELECT * FROM tbl_modul,tbl_modulprak where tbl_modul.id_modulprak = tbl_modulprak.id_modul");
  ...
  case "carisoal":
    ...
    $tampil=mysqli_query($config,"SELECT * FROM tbl_soal WHERE soal LIKE '%$_POST[cari]%'");
    $no=1;
    while ($r=mysqli_fetch_array($tampil)){
       echo "<tr><td>$no</td>
             <td>$r[soal]</td>
