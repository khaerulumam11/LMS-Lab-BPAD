...
elseif ($_GET[hal]=="soal_akhir") {
	include "sidebar.php";
	include "soal_akhir.php";
}
elseif ($_GET[hal]=="listmodul") {
	include "sidebar.php";
	include "listmodul.php";
}
elseif ($_GET[hal]=="modulprak") {
	include "sidebar.php";
	include "modulprak.php";
}
...
elseif ($_GET[hal]=="jawaban_akhir") {
	include "sidebar.php";
	include "jawaban_akhir.php";
}
