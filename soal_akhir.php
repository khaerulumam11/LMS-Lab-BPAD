...
$id_modul = $_GET['id'];
		$cek=mysqli_num_rows(mysqli_query($config,"SELECT id_user FROM tbl_nilaiakhir WHERE id_user='$_SESSION[iduser]' and id_modul = '$id_modul' AND keterangan ='Lulus'"));
		if ($cek > 0) {
			      $tampil = mysqli_query($config,"SELECT * FROM tbl_nilaiakhir WHERE id_user='$_SESSION[iduser]' and id_modul = '$id_modul' AND keterangan = 'Lulus'");
...
echo "<div style='width:100%; border: 1px solid #EBEBEB; overflow:scroll;height:700px;'>";
 echo '<table width="100%" border="0">
        <form name="form1" method="post" action="?hal=jawaban_akhir">
        Kode Asisten :
